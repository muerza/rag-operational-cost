...
class PersistentChatBotUI:
    ...
    def stream_message_handler(self, user_message: str, history: list) -> Generator[Tuple[str, list], None, None]:
    ...
    def _choices_with_current(self) -> list[str]:
    ...
    def update_session_choices(self) -> dict:
        """Return a Gradio update refreshing the dropdown options and selection."""
        return gr.update(
            choices=self._choices_with_current(),
